...
Oben rechts im Frontend kann zwischen `Admin`, `Auditor` und `Viewer` gewechselt werden. Das ist bewusst ohne Login umgesetzt, aber der API-Client sendet die Rolle bereits per Header, sodass später echte Authentifizierung ergänzt werden kann.
